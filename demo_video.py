...
def plot_original_images(batch):
  plt.figure(figsize=(15,15))
  plt.subplot(121)
  plt.imshow(batch['left_image'][0].permute(1, 2, 0))
  plt.title("Left Image")
  plt.axis('off')
  plt.subplot(122)
  plt.imshow(batch['right_image'][0].permute(1, 2, 0))
...
if __name__ == "__main__":
    ...
    for batch_with_single_item in dataloader:
        # plot_original_images(batch_with_single_item)
